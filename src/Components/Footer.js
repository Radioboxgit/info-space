...
export default function Footer(){
    return (
        <div className={styles.container}>
            ...
            <div className={styles.copy}> <FaRegCopyright style={ { color: "white","fontSize":"15px","margin":"2px"}}/>  Copyright 2022 INFO-SPACE Powered By<a href="https://anigbogu.webflow.io" rel="noreferrer" target="_blank" >@codeclas</a> </div>        
        </div>
    )
}