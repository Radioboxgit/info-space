        ...
        <>
           {/* <div className={styles['banner-heading']}> 
            ...
            <div className={styles['banner-heading']}> 
                    <div className={styles.logo}>iNFO <FaBlog style={style}/>SPACE</div>
                    <div className={styles['banner-link']}> 
                        <div><NavLink to="/"  style={({ isActive }) => (isActive ? {color: '#fc8800'} : {color: 'rgb(255, 255, 255)'})}>HOME</NavLink></div>
                        <div><NavLink to="/flights" style={({ isActive }) => (isActive ? {color: '#fc8800'} : {color: 'rgb(255, 255, 255)'})}>FLIGHTS</NavLink></div>
                        <div><NavLink to="/about" style={({ isActive }) => (isActive ? {color: '#fc8800'} : {color: 'rgb(255, 255, 255)'})}>ABOUT US</NavLink></div>
                    </div>
            </div>
